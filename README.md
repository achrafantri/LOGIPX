...
* **Segmentation Masks:** Instance segmentation masks were prioritized over simple bounding boxes to provide **precise pixel-level geometry**, essential for accurate monocular 3D reconstruction and isolating package features from background clutter.
* **Visual Packaging Diversity:** The dataset includes a wide range of package characteristics to prevent feature over-fitting:

  * **Colors & Textures:** Variation across brown cardboard, white boxes, plastic mailers, and printed labels.
  * **Surface Conditions:** Includes glossy/reflective surfaces and matte textures, challenging standard RGB models.
  * **Occlusions & Stacking:** Contains numerous examples of partially visible, stacked, or overlapping packages.

---

## 🖼️ Visual Data Examples

These images demonstrate the high-quality annotations and complex scenarios covered by **LOGIPX**.
**(Ensure these images are stored in an `assets/` folder in your repository)**
